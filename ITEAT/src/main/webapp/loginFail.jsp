...
<link rel="stylesheet" href="assets/css/loginFailStyle.css" />
	...
	<form action="LoginCon">
        ...
        <div class="info_login">
          ...
          <div>
            ...
            <input type="password" id="uif_pw" name="uif_pw" value="" onfocus="inputColorGreen2()" onblur="inputColorReturn2()" required>
          </div>
          <br>
          <div>
          	<span class="loginFailOutput">아이디 또는 비밀번호를 잘못 입력했습니다.</span><br>
          	<span class="loginFailOutput">입력하신 내용을 다시 확인해주세요.</span>
          </div>
