...
<head>
    ...
    <link rel="stylesheet" href="assets/css/sea_index.css?vers324">
</head>
<body id="sea_main">
...
%>
 ...
 <div class="bt">
        <a href="sea_writer.jsp"><button id="writer">코드작성</button></a>
    </div>
    
    
     <div class="bt">
        <a href="sea_list.jsp"><button id="list">코드목록</button></a>
    </div>
